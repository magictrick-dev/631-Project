...
void
set_pixel(i32 x, i32 y, f32 r, f32 g, f32 b)
{

    u8 red          = (u8)(255.0f * r);   
    u8 green        = (u8)(255.0f * g);   
    u8 blue         = (u8)(255.0f * b);
    ...
    setfps[bounded](x, y, window->device, color);

}

void
set_fill(f32 r, f32 g, f32 b)
{
...
void
set_line(i32 x1, i32 x2, i32 y1, i32 y2, i32 z1, i32 z2, f32 r, f32 g, f32 b)
{
